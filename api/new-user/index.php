...
:root{color-scheme:dark;font-family:system-ui,sans-serif;background:#001e60;color:#fff}html{overflow-x:hidden;scrollbar-width:none}html::-webkit-scrollbar,body::-webkit-scrollbar{display:none}body{margin:0;min-height:100dvh;display:grid;place-items:center;padding:12px;box-sizing:border-box;overflow-x:hidden;scrollbar-width:none}form{width:min(100%,520px);background:#293746;border:1px solid #a9ddf7;border-radius:14px;padding:18px;box-sizing:border-box}h1{margin:0 0 10px;text-align:center}label{display:grid;gap:4px;margin:8px 0;font-weight:700}input,button{min-width:0;font:inherit;padding:10px;border-radius:7px;border:1px solid #a9ddf7;box-sizing:border-box}input{width:100%;background:#fff;color:#001e60}button{width:100%;margin-top:8px;background:#0053e2;color:#fff;font-weight:700}#message{min-height:1.4em;margin:6px 0;color:#ffc220}</style></head><body><form id="profile"><h1>Create Profile</h1><label>First Name<input name="firstName" autocomplete="given-name" required maxlength="100"></label><label>Last Name<input name="lastName" autocomplete="family-name" required maxlength="100"></label><label>Preferred Name<input name="preferredName" autocomplete="nickname" maxlength="100"></label><label>Username<input name="username" autocomplete="username" required maxlength="191"></label><label>Password<input name="password" type="password" autocomplete="new-password" required maxlength="72"></label><label>Confirm Password<input name="confirmPassword" type="password" autocomplete="new-password" required maxlength="72"></label><p id="message" role="alert"></p><button type="submit">Create Profile</button></form><script>
