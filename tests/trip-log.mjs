...
let intervalRow=[...root.querySelectorAll('.trip-log-entry')].find(row=>row.textContent.includes('break'));intervalRow.dispatchEvent(new w.PointerEvent('pointerdown',{clientX:50,clientY:10}));await new Promise(resolve=>setTimeout(resolve,600));
